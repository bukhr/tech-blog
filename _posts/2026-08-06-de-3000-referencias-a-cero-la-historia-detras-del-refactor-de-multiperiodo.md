...
Desde sus inicios en el año 2017 Buk nace como una plataforma de gestión de personas chilena. Unos años después, la expansión a México saca a la luz un segmento de mercado importante: hay empresas que pagan a sus colaboradores más de una vez al mes, de forma semanal o incluso quincenal. Al ser una plataforma chilena, Buk estaba diseñado de raíz con un motor de pago mensual.

Al principio, parecía una iteración más: adaptar la app y salir al mercado en unos meses. ¿El problema? Nuestro "villano" silencioso. Existía un método de clase llamado `variable abierta` que asumía un periodo de pago mensual por defecto. Este método estaba fuertemente acoplado en toda la aplicación, sumando más de 3.000 referencias en el codebase (base de código). El acoplamiento era tan tóxico que rompía los límites de dominio: módulos que nada tenían que ver con sueldos —como Talento o Beneficios— se veían forzados a depender de la apertura de un mes de pago para poder operar. Habíamos construido un producto gigante sobre un cimiento mensual, y ahora necesitábamos que soportara semanas y quincenas.
